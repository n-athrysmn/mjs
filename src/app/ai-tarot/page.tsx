...
const AITarotPage = () => {
  ...
  return (
    <div className="justify-content my-20 flex h-[70vh] flex-col items-center gap-5 md:my-10">
      <h3 className="text-center text-lg uppercase text-white md:text-xl">
        Ask a Question to the AI Tarot Reader
      </h3>
